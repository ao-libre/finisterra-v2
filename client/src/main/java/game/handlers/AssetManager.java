...
import static game.Resources.GAME_DESCRIPTORS_PATH;

// TODO convert to SYSTEM!
public class AssetManager extends com.badlogic.gdx.assets.AssetManager implements IAssetManager {
    ...
    public Music getMusic(int key) {
        ...
        try {
            ...
            LOGGER.info("[AssetManager] Error getting music: " + path);
    ...
    private void loadParticles() {
        ...
        Set<String> pFiles = reflections.getResources(Pattern.compile(".*\\.p"));
        pFiles.forEach(pFile -> load(pFile, ParticleEffect.class, params));
    }
